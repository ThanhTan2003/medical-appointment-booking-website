...
import { introspect } from "../../src/services/authenticationService";
...
const Header = () => {
    ...
    const getMyInfor = async (accessToken) => {
        try {
            ...
            const isValidToken = await introspect();
            if (!isValidToken) {
            ...
            // Token hợp lệ, gọi API lấy thông tin người dùng
